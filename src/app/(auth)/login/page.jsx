...
const Page = () => {
      ...
      case "email":
        return value.trim()
          ? emailRegex.test(value)
            ? ""
            : "Uh-oh! That's not a valid email."
          : "Email is required!";
      case "password":
        return value.trim()
  ...
  return (
    <form
      ...
      className=" w-[544px] flex flex-col absolute left-[11.11vw] top-[18vh] lg:left-1/2 lg:transform lg:-translate-x-1/2 sm:w-[86.7vw] mob:top-[19.3vh]"
    >
      <div className=" text-[#fff] font-sans text-[2.5rem] font-semibold">
        Login
      </div>
      <div className=" flex flex-col gap-[8px] mt-[3.8vh] text-[#F5FEF9] mob:gap-[14px] mob:mt-[8vh] ">
        <div className="label relative w-[100%] h-[11.9vh] pt-[3.8vh] pb-[3.5vh] mob:h-[8vh] mob:pb-[2vh] mob:pt-[2.6vh] mob:text-[4.5vw]">
          ...
          />
          {inputs.email ? (
            <div className="tex absolute top-[0px] text-[18px] font-[500] mob:text-[3.3vw]">
              Email
            </div>
          ) : null}
          <hr
      ...
      <div
        className="btn text-[#35CCCD] font-sans text-base font-semibold leading-[145%] tracking-wider ml-auto mob:mt-[16px]"
