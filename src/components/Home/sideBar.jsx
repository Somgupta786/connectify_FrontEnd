...
const SideBar = () => {
  return (
    <div  className="btn relative flex flex-col gap-[9.5vh] px-[14px] py-[4.4vh] w-[16.66%] z bg-[#16202A] rounded-tr-[12px] text-[1.12rem] font-[500] not-italic leading-[25.2px] tracking-[0.72px] font-FontPro text-[#F5FEF9] ">
